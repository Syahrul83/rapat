...
new class extends Component {
    ...
    public function mount($id)
    {
        ...
        $this->kepalaId = $kepala->id;
        $this->name = $kepala->name;
        $this->nip = $kepala->nip;
        $this->existingTtd = $kepala->ttd_image;
    }
    ...
    public function save()
    {
        ...
        Kepala::findOrFail($this->kepalaId)->update($data);

        session()->flash('success', 'Kepala berhasil diperbarui');
...
<div>
    <div class="max-w-lg">
        ...
        <h1 class="text-headline-md text-primary mb-6">Edit Kepala</h1>
