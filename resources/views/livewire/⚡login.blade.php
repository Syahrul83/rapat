...
<div class="flex flex-col min-h-screen bg-background font-sans">
    <header
        class="bg-surface border-b border-outline-variant flex justify-between items-center w-full px-4 md:px-8 h-16">
    ...
    <main class="flex-grow flex items-center justify-center px-4 py-12">
        <div class="w-full max-w-[440px]">
            <div class="bg-surface-container-lowest rounded-lg border border-outline-variant/50 shadow-lg p-6 md:p-8"
                style="opacity: 1; transform: translateY(0px); transition: all 0.5s cubic-bezier(0.4, 0, 0.2, 1);">
                <div class="flex flex-col items-center mb-8 text-center">
                    ...
                    <p class="text-on-surface-variant text-body-sm mt-1">Silakan gunakan kredensial resmi instansi Anda.
                    </p>
                </div>
                ...
                <form wire:submit="login" class="space-y-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="relative group" x-data="{ show: false }">
                            ...
                            <input wire:model.live="password" id="password" :type="show ? 'text' : 'password'"
                                placeholder="••••••••"
                    ...
                    <div class="flex gap-4 p-4 bg-surface-container-low rounded-lg border border-outline-variant/20">
                        ...
                        <div class="space-y-0.5">
                            ...
                            <p class="text-[12px] leading-[16px] text-on-surface-variant">Pastikan Anda terhubung ke
                                jaringan VPN Instansi yang terenkripsi sebelum mengakses portal ini.</p>
                        </div>
                    </div>

                    <button type="submit"
                        class="w-full py-3 px-6 bg-primary text-on-primary font-bold rounded-lg shadow-sm hover:brightness-95 active:scale-[0.98] transition-all flex items-center justify-center gap-2">
            ...
            <p class="text-center mt-8 text-on-surface-variant text-body-sm">
                Kesulitan mengakses akun? <a href="#" class="text-primary font-bold hover:underline">Hubungi
                    Helpdesk IT</a>
            </p>
        </div>
    </main>
    ...
    <footer class="w-full py-6 px-4 md:px-8 mt-auto bg-surface-container-low border-t border-outline-variant">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="flex flex-col items-center md:items-start gap-1">
                <span class="text-label-md text-secondary">&copy; 2024 Sistem Administrasi Digital. Seluruh Hak Cipta
                    Dilindungi.</span>
            </div>
